...
con = DriverManager.getConnection("jdbc:oracle:thin:@LAPTOP-ONDH6FL6:1521:XE","M1","M1");
  ...
  String query="select * from Sang where Event='Cricket' and Stream='MBA' and Sex='Female' order by Enrollment";
...
on = DriverManager.getConnection("jdbc:oracle:thin:@LAPTOP-ONDH6FL6:1521:XE","M1","M1");
  ...
  String sql="select * from Sang where Event='Football' and Stream='MBA' and Sex='Female' order by Enrollment";
...
c = DriverManager.getConnection("jdbc:oracle:thin:@LAPTOP-ONDH6FL6:1521:XE","M1","M1");
  ...
  String sq="select * from Sang where Event='VolleyBall' and Stream='MBA' and Sex='Female' order by Enrollment";
...
cn = DriverManager.getConnection("jdbc:oracle:thin:@LAPTOP-ONDH6FL6:1521:XE","M1","M1");
  ...
  String ql="select * from Sang where Event='Kabaddi' and Stream='MBA' and Sex='Female' order by Enrollment";
...
co = DriverManager.getConnection("jdbc:oracle:thin:@LAPTOP-ONDH6FL6:1521:XE","M1","M1");
  ...
  String l="select * from Sang where Event IN('Chess','TableTennis','Carrom','Badminton')  and Stream='MBA' and Sex='Female' order by Enrollment";
